        ...
        for j in range(0,delta_N):
            ...
            for k in range(0,lamda_N):
                ...
                for m in range(0,n_points):
                    Y[m,count] = temp1[m]                                     #Training[different airfoils, pressure in each n_points]
                    X[m,count] = np.real(temp2[m])                            #Z[different airfoils, complex coordinates n_points]
                    X[m + n_points,count] = np.imag(temp2[m]) 
